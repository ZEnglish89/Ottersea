...
scene Scenes[]={TitleScreen,BackGround,Opening,Hungie,Scavenge,Abalone,Hunt,Urchin,Meal,Chow,StillHungie,Urchin2,GoHungry,Sleeping,WakeUp,HideAndSeek,HungryAgain,LastDay,Starvation,Hunt2,Eating,FillUp,FoodComa,Disease,NonFunctional,Kill,Sighting,Shark,Bite,Escape,Chomp,BleedOut,Race,NeutralEnd};
